...
*/
    ...
    function (e) {
        ...
        v.prototype = {
            ...
            open: function (i) {
                ...
                if (!t.isOpen) {
                    ...
                    E("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (w(d, (function (e, t, i, n) {
                    ...
                    }), 16), t.isOpen = !0, t.updateSize(p), E(c), i
                }
                t.updateItemHTML()
            },
            close: function () {
            ...
            updateItemHTML: function () {
                ...
                if (E("BeforeChange", [t.currItem ? t.currItem.type : "", n]), t.currItem = i, !t.currTemplate[n]) {
                    ...
                    E("FirstMarkupParse", r), t.currTemplate[n] = !r || e(r)
                }
                s && s !== i.type && t.container.removeClass("mfp-" + s + "-holder");
                var o = t["get" + n.charAt(0).toUpperCase() + n.slice(1)](i, t.currTemplate[n]);
                t.appendContent(o, n), i.preloaded = !0, E(u, i), s = i.type, t.container.prepend(t.contentContainer), E("AfterChange")
            },
            appendContent: function (e, i) {
                t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && !0 === t.currTemplate[i] ? t.content.find(".mfp-close").length || t.content.append(x()) : t.content = e : t.content = "", E("BeforeAppend"), t.container.addClass("mfp-" + i + "-holder"), t.contentContainer.append(t.content)
            },
            parseEl: function (i) {
                var n, s = t.items[i];
                if (s.tagName ? s = {
                ...
                return s.type = n || t.st.type || "inline", s.index = i, s.parsed = !0, t.items[i] = s, E("ElementParse", s), t.items[i]
            },
            ...
            updateStatus: function (e, n) {
                if (t.preloader) {
                    ...
                    E("UpdateStatus", s), e = s.status, n = s.text, t.preloader.html(n), t.preloader.find("a").on("click", (function (e) {
            ...
            _parseMarkup: function (t, i, n) {
                var s;
                n.data && (i = e.extend(n.data, i)), E(d, [t, i, n]), e.each(i, (function (i, n) {
                ...
                getInline: function (i, n) {
                    if (I(), i.src) {
                        ...
                        if (r.length) {
                            ...
                            o && o.tagName && (C || (T = s.hiddenClass, C = _(T), T = "mfp-" + T), M = r.after(C).detach().removeClass(T)), t.updateStatus("ready")
        ...
        e.magnificPopup.registerModule(O, {
            ...
            proto: {
                initAjax: function () {
                    t.types.push(O), k = t.st.ajax.cursor, w(a + "." + O, P), w("BeforeChange." + O, P)
                },
                getAjax: function (i) {
                    ...
                    var n = e.extend({
                        ...
                        success: function (n, s, r) {
                            ...
                            E("ParseAjax", o), t.appendContent(e(o.data), O), i.finished = !0, A(), t._setFocus(), setTimeout((function () {
                                t.wrap.addClass(f)
        ...
        e.magnificPopup.registerModule("image", {
            ...
            proto: {
                ...
                _onImageHasSize: function (e) {
                    e.img && (e.hasSize = !0, z && clearInterval(z), e.isCheckingImgSize = !1, E("ImageHasSize", e), e.imgHidden && (t.content && t.content.removeClass("mfp-loading"), e.imgHidden = !1))
                },
                ...
                getImage: function (i, n) {
                    var s = 0,
                        r = function () {
                            i && (i.img[0].complete ? (i.img.off(".mfploader"), i === t.currItem && (t._onImageHasSize(i), t.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, E("ImageLoadComplete")) : 200 > ++s ? setTimeout(r, 100) : o())
                        },
                        o = function () {
                    ...
                    if (l.length) {
                        ...
                        d.className = "mfp-img", i.el && i.el.find("img").length && (d.alt = i.el.find("img").attr("alt")), i.img = e(d).on("load.mfploader", r).on("error.mfploader", o), d.src = i.src, l.is("img") && (i.img = i.img.clone()), (d = i.img[0]).naturalWidth > 0 ? i.hasSize = !0 : d.width || (i.hasSize = !1)
                    }
            ...
            proto: {
                initGallery: function () {
                    ...
                    return t.direction = !0, !(!i || !i.enabled) && (r += " mfp-gallery", w(c + s, (function () {
                        ...
                        s.counter = o > 1 ? W(i.tCounter, r.index, o) : ""
...
var Swiper = function () {
        ...
        for (let n = 1; n < arguments.length; n += 1) {
            ...
            if (null != s && (i = s, !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
                ...
                for (let t = 0, n = i.length; t < n; t += 1) {
                    ...
                    void 0 !== r && r.enumerable && (d(e[n]) && d(s[n]) ? s[n].__swiper__ ? e[n] = s[n] : c(e[n], s[n]) : !d(e[n]) && d(s[n]) ? (e[n] = {}, s[n].__swiper__ ? e[n] = s[n] : c(e[n], s[n])) : e[n] = s[n])
                }
            }
        }
        var i;
    ...
    function C(e) {
        return void 0 === e && (e = {}), x || (x = function (e) {
            ...
            const p = o.match(/(iPod)(.*OS\s([\d_]+))?/),
                ...
                f = "Win32" === s;
            let m = "MacIntel" === s;
            return !u && m && i.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${d}`) >= 0 && (u = o.match(/(Version)\/([\d.]+)/), u || (u = [0, 1, "13_0_0"]), m = !1), c && !f && (a.os = "android", a.android = !0), (u || h || p) && (a.os = "ios", a.ios = !0), a
        }(e)), x
    }
    ...
    const L = (e, t) => {
        ...
        k = e => {
            ...
            if (e.params.rewind || e.params.loop)
                ...
                for (let n = Math.max(s - t, 0); n <= Math.min(r + t, i - 1); n += 1) n !== s && (n > r || n < s) && I(e, n)
        };
    ...
    function A(e) {
        ...
        Object.assign(o, {
            ...
            isScrolling: void 0,
            startMoving: void 0
        }), d.startX = v, d.startY = y, o.touchStartTime = a(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, l.threshold > 0 && (o.allowThresholdMove = !1);
        let _ = !0;
        p.matches(o.focusableElements) && (_ = !1, "SELECT" === p.nodeName && (o.isTouched = !1)), i.activeElement && i.activeElement.matches(o.focusableElements) && i.activeElement !== p && i.activeElement.blur();
        const E = _ && t.allowTouchMove && l.touchStartPreventDefault;
    ...
    function P(e) {
        ...
        if (!i.allowTouchMove) return c.target.matches(s.focusableElements) || (i.allowClick = !1), void (s.isTouched && (Object.assign(o, {
            startX: h,
            startY: f,
        ...
        if (t.activeElement && c.target === t.activeElement && c.target.matches(s.focusableElements)) return s.isMoved = !0, void (i.allowClick = !1);
        ...
        if (void 0 === s.isScrolling) {
            let e;
            i.isHorizontal() && o.currentY === o.startY || i.isVertical() && o.currentX === o.startX ? s.isScrolling = !1 : m * m + g * g >= 25 && (e = 180 * Math.atan2(Math.abs(g), Math.abs(m)) / Math.PI, s.isScrolling = i.isHorizontal() ? e > r.touchAngle : 90 - e > r.touchAngle)
        }
        if (s.isScrolling && i.emit("touchMoveOpposite", c), void 0 === s.startMoving && (o.currentX === o.startX && o.currentY === o.startY || (s.startMoving = !0)), s.isScrolling || i.zoom && i.params.zoom && i.params.zoom.enabled && s.evCache.length > 1) return void (s.isTouched = !1);
        ...
        let v = i.isHorizontal() ? m : g,
            y = i.isHorizontal() ? o.currentX - o.previousX : o.currentY - o.previousY;
        r.oneWayMovement && (v = Math.abs(v) * (l ? 1 : -1), y = Math.abs(y) * (l ? 1 : -1)), o.diff = v, v *= r.touchRatio, l && (v = -v, y = -y);
        const b = i.touchesDirection;
        i.swipeDirection = v > 0 ? "prev" : "next", i.touchesDirection = y > 0 ? "prev" : "next";
        const w = i.params.loop && !r.cssMode,
            _ = "next" === i.swipeDirection && i.allowSlideNext || "prev" === i.swipeDirection && i.allowSlidePrev;
        if (!s.isMoved) {
            if (w && _ && i.loopFix({
            ...
            s.allowMomentumBounce = !1, !r.grabCursor || !0 !== i.allowSlideNext && !0 !== i.allowSlidePrev || i.setGrabCursor(!0), i.emit("sliderFirstMove", c)
        }
        let E;
        s.isMoved && b !== i.touchesDirection && w && _ && Math.abs(v) >= 1 && (i.loopFix({
            direction: i.swipeDirection,
            setTranslate: !0
        }), E = !0), i.emit("sliderMove", c), s.isMoved = !0, s.currentTranslate = v + s.startTranslate;
        let x = !0,
            S = r.resistanceRatio;
        if (r.touchReleaseOnEdges && (S = 0), v > 0 ? (w && _ && !E && s.currentTranslate > (r.centeredSlides ? i.minTranslate() - i.size / 2 : i.minTranslate()) && i.loopFix({
            direction: "prev",
            setTranslate: !0,
            activeSlideIndex: 0
        }), s.currentTranslate > i.minTranslate() && (x = !1, r.resistance && (s.currentTranslate = i.minTranslate() - 1 + (-i.minTranslate() + s.startTranslate + v) ** S))) : v < 0 && (w && _ && !E && s.currentTranslate < (r.centeredSlides ? i.maxTranslate() + i.size / 2 : i.maxTranslate()) && i.loopFix({
            direction: "next",
            setTranslate: !0,
            activeSlideIndex: i.slides.length - ("auto" === r.slidesPerView ? i.slidesPerViewDynamic() : Math.ceil(parseFloat(r.slidesPerView, 10)))
        }), s.currentTranslate < i.maxTranslate() && (x = !1, r.resistance && (s.currentTranslate = i.maxTranslate() + 1 - (i.maxTranslate() - s.startTranslate - v) ** S))), x && (c.preventedByNestedSwiper = !0), !i.allowSlideNext && "next" === i.swipeDirection && s.currentTranslate < s.startTranslate && (s.currentTranslate = s.startTranslate), !i.allowSlidePrev && "prev" === i.swipeDirection && s.currentTranslate > s.startTranslate && (s.currentTranslate = s.startTranslate), i.allowSlidePrev || i.allowSlideNext || (s.currentTranslate = s.startTranslate), r.threshold > 0) {
    ...
    function z(e) {
        ...
        if (n >= 0 && i.evCache.splice(n, 1), ["pointercancel", "pointerout", "pointerleave", "contextmenu"].includes(e.type) && (!["pointercancel", "contextmenu"].includes(e.type) || !t.browser.isSafari && !t.browser.isWebView)) return;
        const {
            params: s,
            touches: r,
            rtlTranslate: l,
        ...
        let u = e;
        if (u.originalEvent && (u = u.originalEvent), i.allowTouchCallbacks && t.emit("touchEnd", u), i.allowTouchCallbacks = !1, !i.isTouched) return i.isMoved && s.grabCursor && t.setGrabCursor(!1), i.isMoved = !1, void (i.startMoving = !1);
        ...
        if (i.lastClickTime = a(), o(() => {
            t.destroyed || (t.allowClick = !0)
        }), !i.isTouched || !i.isMoved || !t.swipeDirection || 0 === r.diff || i.currentTranslate === i.startTranslate) return i.isTouched = !1, i.isMoved = !1, void (i.startMoving = !1);
        let f;
        if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, f = s.followFinger ? l ? t.translate : -t.translate : -i.currentTranslate, s.cssMode) return;
        ...
        for (let e = 0; e < d.length; e += e < s.slidesPerGroupSkip ? 1 : s.slidesPerGroup) {
            ...
            void 0 !== d[e + t] ? f >= d[e] && f < d[e + t] && (m = e, g = d[e + t] - d[e]) : f >= d[e] && (m = e, g = d[d.length - 1] - d[d.length - 2])
        }
        let v = null,
            y = null;
        ...
        if (h > s.longSwipesMs) {
            ...
            "next" === t.swipeDirection && (b >= s.longSwipesRatio ? t.slideTo(s.rewind && t.isEnd ? v : m + w) : t.slideTo(m)), "prev" === t.swipeDirection && (b > 1 - s.longSwipesRatio ? t.slideTo(m + w) : null !== y && b < 0 && Math.abs(b) > s.longSwipesRatio ? t.slideTo(y) : t.slideTo(m))
        } else {
            if (!s.shortSwipes) return void t.slideTo(t.activeIndex);
            !t.navigation || u.target !== t.navigation.nextEl && u.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(null !== v ? v : m + w), "prev" === t.swipeDirection && t.slideTo(null !== y ? y : m)) : u.target === t.navigation.nextEl ? t.slideTo(m + w) : t.slideTo(m)
        }
    }
    ...
    const R = (e, t) => {
        ...
        r[d]("pointerdown", e.onTouchStart, {
            ...
            passive: !0
        }), (s.preventClicks || s.preventClicksPropagation) && r[d]("click", e.onClick, !0), s.cssMode && o[d]("scroll", e.onScroll), s.updateOnWindowResize ? e[c](a.ios || a.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", D, !0) : e[c]("observerUpdate", D, !0), r[d]("load", e.onLoad, {
            capture: !0
        })
    },
    ...
    const G = {
        ...
        update: {
            ...
            updateSlides: function () {
                ...
                let S = n.spaceBetween,
                    ...
                    M = 0;
                if (void 0 === o) return;
                "string" == typeof S && S.indexOf("%") >= 0 ? S = parseFloat(S.replace("%", "")) / 100 * o : "string" == typeof S && (S = parseFloat(S)), e.virtualSize = -S, p.forEach(e => {
                    a ? e.style.marginLeft = "" : e.style.marginRight = "", e.style.marginBottom = "", e.style.marginTop = ""
                }), n.centeredSlides && n.cssMode && (u(s, "--swiper-centered-offset-before", ""), u(s, "--swiper-centered-offset-after", ""));
                ...
                for (let s = 0; s < h; s += 1) {
                    let r;
                    if (I = 0, p[s] && (r = p[s]), L && e.grid.updateSlide(s, r, h, t), !p[s] || "none" !== v(r, "display")) {
                        if ("auto" === n.slidesPerView) {
                            k && (p[s].style[t("width")] = "");
                            const o = getComputedStyle(r),
                                a = r.style.transform,
                                l = r.style.webkitTransform;
                            if (a && (r.style.transform = "none"), l && (r.style.webkitTransform = "none"), n.roundLengths) I = e.isHorizontal() ? _(r, "width", !0) : _(r, "height", !0);
                            else {
                                const e = i(o, "width"),
                                    t = i(o, "padding-left"),
                                    n = i(o, "padding-right"),
                            ...
                            a && (r.style.transform = a), l && (r.style.webkitTransform = l), n.roundLengths && (I = Math.floor(I))
                        } else I = (o - (n.slidesPerView - 1) * S) / n.slidesPerView, n.roundLengths && (I = Math.floor(I)), p[s] && (p[s].style[t("width")] = I + "px");
                        p[s] && (p[s].swiperSlideSize = I), y.push(I), n.centeredSlides ? (T = T + I / 2 + C / 2 + S, 0 === C && 0 !== s && (T = T - o / 2 - S), 0 === s && (T = T - o / 2 - S), Math.abs(T) < .001 && (T = 0), n.roundLengths && (T = Math.floor(T)), M % n.slidesPerGroup == 0 && m.push(T), g.push(T)) : (n.roundLengths && (T = Math.floor(T)), (M - Math.min(e.params.slidesPerGroupSkip, M)) % e.params.slidesPerGroup == 0 && m.push(T), g.push(T), T = T + I + S), e.virtualSize += I + S, C = I, M += 1
                    }
                }
                if (e.virtualSize = Math.max(e.virtualSize, o) + w, a && l && ("slide" === n.effect || "coverflow" === n.effect) && (s.style.width = e.virtualSize + S + "px"), n.setWrapperSize && (s.style[t("width")] = e.virtualSize + S + "px"), L && e.grid.updateWrapperSize(I, m, t), !n.centeredSlides) {
                    const t = [];
                    for (let i = 0; i < m.length; i += 1) {
                        let s = m[i];
                        n.roundLengths && (s = Math.floor(s)), m[i] <= e.virtualSize - o && t.push(s)
                    }
                ...
                if (Object.assign(e, {
                    ...
                    u(s, "--swiper-centered-offset-before", -m[0] + "px"), u(s, "--swiper-centered-offset-after", e.size / 2 - y[y.length - 1] / 2 + "px");
                    const t = -e.snapGrid[0],
                        i = -e.slidesGrid[0];
                    e.snapGrid = e.snapGrid.map(e => e + t), e.slidesGrid = e.slidesGrid.map(e => e + i)
                }
                if (h !== c && e.emit("slidesLengthChange"), m.length !== E && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), g.length !== x && e.emit("slidesGridLengthChange"), n.watchSlidesProgress && e.updateSlidesOffset(), !(d || n.cssMode || "slide" !== n.effect && "fade" !== n.effect)) {
            ...
            updateSlidesProgress: function (e) {
                ...
                for (let e = 0; e < n.length; e += 1) {
                    ...
                    const c = (o + (i.centeredSlides ? t.minTranslate() : 0) - d) / (l.swiperSlideSize + a),
                        u = (o - r[0] + (i.centeredSlides ? t.minTranslate() : 0) - d) / (l.swiperSlideSize + a),
                        p = -(o - d),
                        h = p + t.slidesSizesGrid[e];
                    (p >= 0 && p < t.size - 1 || h > 1 && h <= t.size || p <= 0 && h >= t.size) && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e), n[e].classList.add(i.slideVisibleClass)), l.progress = s ? -c : c, l.originalProgress = s ? -u : u
                }
            },
            updateProgress: function (e) {
                ...
                Object.assign(t, {
                    ...
                    isBeginning: r,
                    isEnd: o
                }), (i.watchSlidesProgress || i.centeredSlides && i.autoHeight) && t.updateSlidesProgress(e), r && !l && t.emit("reachBeginning toEdge"), o && !d && t.emit("reachEnd toEdge"), (l && !r || d && !o) && t.emit("fromEdge"), t.emit("progress", s)
            },
            ...
            updateActiveIndex: function (e) {
                ...
                if (l >= n.length && (l = n.length - 1), d === r) return l !== a && (t.snapIndex = l, t.emit("snapIndexChange")), void (t.params.loop && t.virtual && t.params.virtual.enabled && (t.realIndex = c(d)));
                let u;
                u = t.virtual && s.virtual.enabled && s.loop ? c(d) : t.slides[d] ? parseInt(t.slides[d].getAttribute("data-swiper-slide-index") || d, 10) : d, Object.assign(t, {
                    previousSnapIndex: a,
                    snapIndex: l,
                    previousRealIndex: o,
                    realIndex: u,
                    previousIndex: r,
                    activeIndex: d
                }), t.initialized && k(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), (t.initialized || t.params.runCallbacksOnInit) && (o !== u && t.emit("realIndexChange"), t.emit("slideChange"))
            },
        ...
        translate: {
            ...
            setTranslate: function (e, t) {
                ...
                let a, l = 0,
                    d = 0;
                i.isHorizontal() ? l = n ? -e : e : d = e, s.roundLengths && (l = Math.floor(l), d = Math.floor(d)), i.previousTranslate = i.translate, i.translate = i.isHorizontal() ? l : d, s.cssMode ? r[i.isHorizontal() ? "scrollLeft" : "scrollTop"] = i.isHorizontal() ? -l : -d : s.virtualTranslate || (i.isHorizontal() ? l -= i.cssOverflowAdjustment() : d -= i.cssOverflowAdjustment(), r.style.transform = `translate3d(${l}px, ${d}px, 0px)`);
                const c = i.maxTranslate() - i.minTranslate();
                a = 0 === c ? 0 : (e - i.minTranslate()) / c, a !== o && i.updateProgress(e), i.emit("setTranslate", i.translate, t)
            },
        ...
        transition: {
            ...
            transitionStart: function (e, t) {
                ...
                n.cssMode || (n.autoHeight && i.updateAutoHeight(), O({
                    swiper: i,
                    runCallbacks: e,
                    direction: t,
                    step: "Start"
            ...
            transitionEnd: function (e, t) {
                ...
                i.animating = !1, n.cssMode || (i.setTransition(0), O({
                    swiper: i,
                    runCallbacks: e,
                    direction: t,
                    step: "End"
        ...
        slide: {
            slideTo: function (e, t, i, n, s) {
                ...
                if (r.animating && a.preventInteractionOnTransition || !m && !n && !s) return !1;
                ...
                if (r.initialized && o !== u) {
                    if (!r.allowSlideNext && (h ? y > r.translate && y > r.minTranslate() : y < r.translate && y < r.minTranslate())) return !1;
                    if (!r.allowSlidePrev && y > r.translate && y > r.maxTranslate() && (u || 0) !== o) return !1
                }
                let b;
                if (o !== (c || 0) && i && r.emit("beforeSlideChangeStart"), r.updateProgress(y), b = o > u ? "next" : o < u ? "prev" : "reset", h && -y === r.translate || !h && y === r.translate) return r.updateActiveIndex(o), a.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), "slide" !== a.effect && r.setTranslate(y), "reset" !== b && (r.transitionStart(i, b), r.transitionEnd(i, b)), !1;
                if (a.cssMode) {
                    const e = r.isHorizontal(),
                        i = h ? y : -y;
                    if (0 === t) {
                ...
                return r.setTransition(t), r.setTranslate(y), r.updateActiveIndex(o), r.updateSlidesClasses(), r.emit("beforeTransitionStart", t, n), r.transitionStart(i, b), 0 === t ? r.transitionEnd(i, b) : r.animating || (r.animating = !0, r.onSlideToWrapperTransitionEnd || (r.onSlideToWrapperTransitionEnd = function (e) {
            ...
            slideNext: function (e, t, i) {
                ...
                return r.rewind && n.isEnd ? n.slideTo(0, e, t, i) : n.slideTo(n.activeIndex + l)
            },
            slidePrev: function (e, t, i) {
                ...
                let m = 0;
                if (void 0 !== f && (m = o.indexOf(f), m < 0 && (m = n.activeIndex - 1), "auto" === s.slidesPerView && 1 === s.slidesPerGroup && s.slidesPerGroupAuto && (m = m - n.slidesPerViewDynamic("previous", !0) + 1, m = Math.max(m, 0))), s.rewind && n.isBeginning) {
            ...
            slideToClickedSlide: function () {
                ...
                if (t.loop) {
                    ...
                    s = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? r < e.loopedSlides - n / 2 || r > e.slides.length - e.loopedSlides + n / 2 ? (e.loopFix(), r = e.getSlideIndex(f(i, `${a}[data-swiper-slide-index="${s}"]`)[0]), o(() => {
                        e.slideTo(r)
                    })) : e.slideTo(r) : r > e.slides.length - n ? (e.loopFix(), r = e.getSlideIndex(f(i, `${a}[data-swiper-slide-index="${s}"]`)[0]), o(() => {
                        e.slideTo(r)
                    })) : e.slideTo(r)
                } else e.slideTo(r)
            }
        ...
        loop: {
            ...
            loopFix: function (e) {
                ...
                if (r < m) {
                    ...
                    E = Math.max(r - (l.slides.length - 2 * m), h.slidesPerGroup);
                    for (let e = 0; e < E; e += 1) {
                        const t = e - Math.floor(e / d.length) * d.length;
                        v.push(t)
                    }
                ...
                if (w && g.forEach(e => {
                    ...
                    if (g.length > 0 && w)
                        if (void 0 === t) {
                            ...
                            a ? l.setTranslate(l.translate - t) : (l.slideTo(y + _, 0, !1, !0), s && (l.touches[l.isHorizontal() ? "startX" : "startY"] += t, l.touchEventsData.currentTranslate = l.translate))
                        } else s && (l.slideToLoop(t, 0, !1, !0), l.touchEventsData.currentTranslate = l.translate);
                    else if (v.length > 0 && b)
                        if (void 0 === t) {
                            const e = l.slidesGrid[y],
                                t = l.slidesGrid[y - E] - e;
                            a ? l.setTranslate(l.translate - t) : (l.slideTo(y - E, 0, !1, !0), s && (l.touches[l.isHorizontal() ? "startX" : "startY"] += t, l.touchEventsData.currentTranslate = l.translate))
        ...
        events: {
            attachEvents: function () {
                ...
                e.onTouchStart = A.bind(e), e.onTouchMove = P.bind(e), e.onTouchEnd = z.bind(e), i.cssMode && (e.onScroll = N.bind(e)), e.onClick = j.bind(e), e.onLoad = H.bind(e), B || (t.addEventListener("touchstart", W), B = !0), R(e, "on")
            },
        ...
        breakpoints: {
            setBreakpoint: function () {
                ...
                }), u && !m ? e.disable() : !u && m && e.enable(), e.currentBreakpoint = o, e.emit("_beforeBreakpoint", a), i && (h ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !f && g ? (e.loopCreate(t), e.updateSlides()) : f && !g && e.loopDestroy()), e.emit("breakpoint", a)
            },
    ...
    class V {
        constructor() {
            ...
            1 === s.length && s[0].constructor && "Object" === Object.prototype.toString.call(s[0]).slice(8, -1) ? t = s[0] : [e, t] = s, t || (t = {}), t = c({}, t), e && !t.el && (t.el = e);
            const o = n();
            ...
            const a = this;
            a.__swiper__ = !0, a.support = T(), a.device = C({
                userAgent: t.userAgent
            }), a.browser = M(), a.eventsListeners = {}, a.eventsAnyListeners = [], a.modules = [...a.__modules__], t.modules && Array.isArray(t.modules) && a.modules.push(...t.modules);
            const l = {};
            a.modules.forEach(e => {
                e({
                    params: t,
            ...
            const d = c({}, q, l);
            return a.params = c({}, d, $, t), a.originalParams = c({}, a.params), a.passedParams = c({}, t), a.params && a.params.on && Object.keys(a.params.on).forEach(e => {
        ...
        getSlideIndex(e) {
            const {
                slidesEl: t,
                params: i
            } = this, n = y(f(t, `.${i.slideClass}, swiper-slide`)[0]);
            return y(e) - n
        }
        ...
        mount(e) {
            ...
            let s = i && i.shadowRoot && i.shadowRoot.querySelector ? i.shadowRoot.querySelector(n()) : f(i, n())[0];
            return !s && t.params.createElements && (s = m("div", t.params.wrapperClass), i.append(s), f(i, "." + t.params.slideClass).forEach(e => {
                s.append(e)
            })), Object.assign(t, {
                el: i,
                wrapperEl: s,
        ...
        destroy(e, t) {
            ...
            return void 0 === i.params || i.destroyed || (i.emit("beforeDestroy"), i.initialized = !1, i.detachEvents(), n.loop && i.loopDestroy(), t && (i.removeClasses(), s.removeAttribute("style"), r.removeAttribute("style"), o && o.length && o.forEach(e => {
    ...
    function X(e, t, i, n) {
        return e.params.createElements && Object.keys(n).forEach(s => {
            if (!i[s] && !0 === i.auto) {
                let r = f(e.el, "." + n[s])[0];
                r || (r = m("div", n[s]), r.className = n[s], e.el.append(r)), i[s] = r, t[s] = r
            }
        }), i
    }
    ...
    Object.keys(G).forEach(e => {
        ...
        i("init", () => {
            ...
            }), o.observe(t.el)) : (s.addEventListener("resize", l), s.addEventListener("orientationchange", d))
        }), i("destroy", () => {
            a && s.cancelAnimationFrame(a), o && o.unobserve && t.el && (o.unobserve(t.el), o = null), s.removeEventListener("resize", l), s.removeEventListener("orientationchange", d)
        })
    }, function (e) {
        let {
            swiper: t,
    ...
    const re = [function (e) {
        ...
        function d(e, t) {
            ...
            let s;
            return n.renderSlide ? (s = n.renderSlide.call(i, e, t), "string" == typeof s && (l.innerHTML = s, s = l.children[0])) : s = i.isElement ? m("swiper-slide") : m("div", i.params.slideClass), s.setAttribute("data-swiper-slide-index", t), n.renderSlide || (s.innerHTML = e), n.cache && (i.virtual.cache[t] = s), s
        }
        ...
        function c(e) {
            ...
            let v, y, b;
            v = i.rtlTranslate ? "right" : i.isHorizontal() ? "left" : "top", s ? (y = Math.floor(t / 2) + n + l, b = Math.floor(t / 2) + n + a) : (y = t + (n - 1) + l, b = (r ? t : n) + a);
            let w = g - b,
                _ = g + y;
            ...
            if (r && g >= b ? (w -= b, s || (E += i.slidesGrid[0])) : r && g < b && (w = -b, s && (E += i.slidesGrid[0])), Object.assign(i.virtual, {
                from: w,
                to: _,
                offset: E,
                ...
                slidesBefore: b,
                slidesAfter: y
            }), c === w && u === _ && !e) return i.slidesGrid !== h && E !== m && i.slides.forEach(e => {
            ...
            }), void (i.params.virtual.renderExternalUpdate ? x() : o("virtualUpdate"));
            const S = [],
                T = [],
                C = e => {
                    let t = e;
            ...
            if (e) i.slides.filter(e => e.matches(`.${i.params.slideClass}, swiper-slide`)).forEach(e => {
                ...
                for (let e = c; e <= u; e += 1)
                    ...
                    } const M = r ? -p.length : 0,
                        L = r ? 2 * p.length : p.length;
            for (let t = M; t < L; t += 1)
                if (t >= w && t <= _) {
                    const i = C(t);
                    void 0 === u || e ? T.push(i) : (t > u && T.push(i), t < c && S.push(i))
                } if (T.forEach(e => {
        ...
        r("beforeInit", () => {
            ...
            e || (i.virtual.slides = i.params.virtual.slides), i.classNames.push(i.params.containerModifierClass + "virtual"), i.params.watchSlidesProgress = !0, i.originalParams.watchSlidesProgress = !0, c()
        }), r("setTranslate", () => {
        ...
        function d(e) {
            ...
            if (!t.allowSlidePrev && (t.isHorizontal() && u || t.isVertical() && h || d)) return !1;
            if (!(n.shiftKey || n.altKey || n.ctrlKey || n.metaKey || a.activeElement && a.activeElement.nodeName && ("input" === a.activeElement.nodeName.toLowerCase() || "textarea" === a.activeElement.nodeName.toLowerCase()))) {
                ...
                t.isHorizontal() ? ((d || c || u || p) && (n.preventDefault ? n.preventDefault() : n.returnValue = !1), ((c || p) && !i || (d || u) && i) && t.slideNext(), ((d || u) && !i || (c || p) && i) && t.slidePrev()) : ((d || c || h || f) && (n.preventDefault ? n.preventDefault() : n.returnValue = !1), (c || f) && t.slideNext(), (d || h) && t.slidePrev()), o("keyPress", s)
            }
        }

        function c() {
            t.keyboard.enabled || (a.addEventListener("keydown", d), t.keyboard.enabled = !0)
        }

        function u() {
            t.keyboard.enabled && (a.removeEventListener("keydown", d), t.keyboard.enabled = !1)
        }
        t.keyboard = {
            enabled: !1
        }, i({
        ...
        function m(e) {
            return !(t.params.mousewheel.thresholdDelta && e.delta < t.params.mousewheel.thresholdDelta || t.params.mousewheel.thresholdTime && a() - u < t.params.mousewheel.thresholdTime || !(e.delta >= 6 && a() - u < 60) && (e.direction < 0 ? t.isEnd && !t.params.loop || t.animating || (t.slideNext(), s("scroll", e.raw)) : t.isBeginning && !t.params.loop || t.animating || (t.slidePrev(), s("scroll", e.raw)), u = (new l.Date).getTime(), 1))
        }
        ...
        function g(e) {
            ...
            if (v >= t.minTranslate() && (v = t.minTranslate()), v <= t.maxTranslate() && (v = t.maxTranslate()), n = !!t.params.loop || !(v === t.minTranslate() || v === t.maxTranslate()), n && t.params.nested && i.stopPropagation(), t.params.freeMode && t.params.freeMode.enabled) {
                ...
                if (!n) {
                    ...
                    if (n || s("scroll", i), t.params.autoplay && t.params.autoplayDisableOnInteraction && t.autoplay.stop(), r.releaseOnEdges && (a === t.minTranslate() || a === t.maxTranslate())) return !0
                }
            } else {
                const i = {
                    time: a(),
        ...
        function u() {
            ...
            if (t.params.navigation = X(t, t.originalParams.navigation, t.params.navigation, {
            ...
            const s = (i, n) => {
                i && i.addEventListener("click", "next" === n ? c : d), !t.enabled && i && i.classList.add(...e.lockClass.split(" "))
            };
        ...
        n("init", () => {
            ...
            if (t.params.navigation.hideOnClick && !o.includes(a) && !n.includes(a)) {
                ...
                let e;
                n.length ? e = n[0].classList.contains(t.params.navigation.hiddenClass) : o.length && (e = o[0].classList.contains(t.params.navigation.hiddenClass)), s(!0 === e ? "navigationShow" : "navigationHide"), [...n, ...o].filter(e => !!e).forEach(e => e.classList.toggle(t.params.navigation.hiddenClass))
            }
        });
        const h = () => {
        ...
        function p() {
            ...
            if (t.params.loop ? (r = t.previousRealIndex || 0, n = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (n = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, n = t.activeIndex || 0), "bullets" === i.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                ...
                let l, d, p;
                if (i.dynamicBullets && (o = _(s[0], t.isHorizontal() ? "width" : "height", !0), u.forEach(e => {
                    e.style[t.isHorizontal() ? "width" : "height"] = o * (i.dynamicMainBullets + 4) + "px"
                }), i.dynamicMainBullets > 1 && void 0 !== r && (a += n - (r || 0), a > i.dynamicMainBullets - 1 ? a = i.dynamicMainBullets - 1 : a < 0 && (a = 0)), l = Math.max(n - a, 0), d = l + (Math.min(s.length, i.dynamicMainBullets) - 1), p = (d + l) / 2), s.forEach(e => {
                    ...
                    const s = y(e);
                    s === n ? e.classList.add(...i.bulletActiveClass.split(" ")) : t.isElement && e.setAttribute("part", "bullet"), i.dynamicBullets && (s >= l && s <= d && e.classList.add(...(i.bulletActiveClass + "-main").split(" ")), s === l && c(e, "prev"), s === d && c(e, "next"))
                });
                else {
                    const e = s[n];
                    if (e && e.classList.add(...i.bulletActiveClass.split(" ")), t.isElement && s.forEach((e, t) => {
                        ...
                        const e = s[l],
                            t = s[d];
                        for (let e = l; e <= d; e += 1) s[e] && s[e].classList.add(...(i.bulletActiveClass + "-main").split(" "));
                        c(e, "prev"), c(t, "next")
                    }
                }
                if (i.dynamicBullets) {
            ...
            u.forEach((e, r) => {
                if ("fraction" === i.type && (e.querySelectorAll(U(i.currentClass)).forEach(e => {
                    ...
                    let o = 1,
                        a = 1;
                    "horizontal" === s ? o = r : a = r, e.querySelectorAll(U(i.progressbarFillClass)).forEach(e => {
                        e.style.transform = `translate3d(0,0,0) scaleX(${o}) scaleY(${a})`, e.style.transitionDuration = t.params.speed + "ms"
                    })
                }
                "custom" === i.type && i.renderCustom ? (e.innerHTML = i.renderCustom(t, n + 1, h), 0 === r && s("paginationRender", e)) : (0 === r && s("paginationRender", e), s("paginationUpdate", e)), t.params.watchOverflow && t.enabled && e.classList[t.isLocked ? "add" : "remove"](i.lockClass)
            })
        }
        ...
        function f() {
            t.params.pagination = X(t, t.originalParams.pagination, t.params.pagination, {
        ...
        function v() {
            ...
            let a = d,
                l = (c - d) * o;
            i ? (l = -l, l > 0 ? (a = d - l, l = 0) : -l + d > c && (a = c + l)) : l < 0 ? (a = d + l, l = 0) : l + d > c && (a = c - l), t.isHorizontal() ? (n.style.transform = `translate3d(${l}px, 0, 0)`, n.style.width = a + "px") : (n.style.transform = `translate3d(0px, ${l}px, 0)`, n.style.height = a + "px"), r.hide && (clearTimeout(h), s.style.opacity = 1, h = setTimeout(() => {
        ...
        function y() {
            ...
            i.style.width = "", i.style.height = "", c = t.isHorizontal() ? n.offsetWidth : n.offsetHeight, u = t.size / (t.virtualSize + t.params.slidesOffsetBefore - (t.params.centeredSlides ? t.snapGrid[0] : 0)), d = "auto" === t.params.scrollbar.dragSize ? c * u : parseInt(t.params.scrollbar.dragSize, 10), t.isHorizontal() ? i.style.width = d + "px" : i.style.height = d + "px", n.style.display = u >= 1 ? "none" : "", t.params.scrollbar.hide && (n.style.opacity = 0), t.params.watchOverflow && t.enabled && e.el.classList[t.isLocked ? "add" : "remove"](t.params.scrollbar.lockClass)
        }
        ...
        function w(e) {
            ...
            let r;
            r = (b(e) - g(s)[t.isHorizontal() ? "left" : "top"] - (null !== l ? l : d / 2)) / (c - d), r = Math.max(Math.min(r, 1), 0), n && (r = 1 - r);
        ...
        function _(e) {
            ...
            p = !0, l = e.target === a ? b(e) - e.target.getBoundingClientRect()[t.isHorizontal() ? "left" : "top"] : null, e.preventDefault(), e.stopPropagation(), s.style.transitionDuration = "100ms", a.style.transitionDuration = "100ms", w(e), clearTimeout(f), o.style.transitionDuration = "0ms", i.hide && (o.style.opacity = 1), t.params.cssMode && (t.wrapperEl.style["scroll-snap-type"] = "none"), r("scrollbarDragStart", e)
        }
        ...
        function E(e) {
            ...
            p && (e.preventDefault ? e.preventDefault() : e.returnValue = !1, w(e), n.style.transitionDuration = "0ms", s.style.transitionDuration = "0ms", o.style.transitionDuration = "0ms", r("scrollbarDragMove", e))
        }
        ...
        function x(e) {
            ...
            p && (p = !1, t.params.cssMode && (t.wrapperEl.style["scroll-snap-type"] = "", s.style.transitionDuration = ""), i.hide && (clearTimeout(f), f = o(() => {
        ...
        function S(e) {
            ...
            r[d]("pointerdown", _, o), a[d]("pointermove", E, o), a[d]("pointerup", x, l)
        }
        ...
        i({
            ...
            !1 === t.params.scrollbar.enabled ? M() : (T(), y(), v())
        ...
        const s = "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]",
            r = (e, i) => {
                ...
                if (o || a ? (o = o || "0", a = a || "0") : t.isHorizontal() ? (o = r, a = "0") : (a = r, o = "0"), o = o.indexOf("%") >= 0 ? parseInt(o, 10) * i * s + "%" : o * i * s + "px", a = a.indexOf("%") >= 0 ? parseInt(a, 10) * i + "%" : a * i + "px", null != d) {
                    const t = d - (d - 1) * (1 - Math.abs(i));
                    e.style.opacity = t
                }
                let u = `translate3d(${o}, ${a}, 0px)`;
                null != l && (u += ` scale(${l - (l - 1) * (1 - Math.abs(i))})`), c && null != c && (u += ` rotate(${c * i * -1}deg)`), e.style.transform = u
            },
            o = () => {
                const {
                    el: e,
                ...
                t.isElement && l.push(...f(t.hostEl, s)), l.forEach(e => {
                    r(e, n)
                }), i.forEach((e, i) => {
                    let a = e.progress;
        ...
        function x(e) {
            ...
            s >= 0 && (p[s] = e), p.length < 2 || (d = !0, h.scaleMove = w(), h.imageEl && (n.scale = h.scaleMove / h.scaleStart * c, n.scale > h.maxRatio && (n.scale = h.maxRatio - 1 + (n.scale - h.maxRatio + 1) ** .5), n.scale < i.minRatio && (n.scale = i.minRatio + 1 - (i.minRatio - n.scale + 1) ** .5), h.imageEl.style.transform = `translate3d(0,0,0) scale(${n.scale})`))
        }
        ...
        function T(e) {
            ...
            if (m.minX = Math.min(h.slideWidth / 2 - n / 2, 0), m.maxX = -m.minX, m.minY = Math.min(h.slideHeight / 2 - s / 2, 0), m.maxY = -m.minY, m.touchesCurrent.x = p.length > 0 ? p[0].pageX : e.pageX, m.touchesCurrent.y = p.length > 0 ? p[0].pageY : e.pageY, Math.max(Math.abs(m.touchesCurrent.x - m.touchesStart.x), Math.abs(m.touchesCurrent.y - m.touchesStart.y)) > 5 && (t.allowClick = !1), !m.isMoved && !u) {
            ...
            m.currentX = m.touchesCurrent.x - m.touchesStart.x + m.startX + r * (m.width - 2 * o), m.currentY = m.touchesCurrent.y - m.touchesStart.y + m.startY + r * (m.height - 2 * a), m.currentX < m.minX && (m.currentX = m.minX + 1 - (m.minX - m.currentX + 1) ** .8), m.currentX > m.maxX && (m.currentX = m.maxX - 1 + (m.currentX - m.maxX + 1) ** .8), m.currentY < m.minY && (m.currentY = m.minY + 1 - (m.minY - m.currentY + 1) ** .8), m.currentY > m.maxY && (m.currentY = m.maxY - 1 + (m.currentY - m.maxY + 1) ** .8), v.prevPositionX || (v.prevPositionX = m.touchesCurrent.x), v.prevPositionY || (v.prevPositionY = m.touchesCurrent.y), v.prevTime || (v.prevTime = Date.now()), v.x = (m.touchesCurrent.x - v.prevPositionX) / (Date.now() - v.prevTime) / 2, v.y = (m.touchesCurrent.y - v.prevPositionY) / (Date.now() - v.prevTime) / 2, Math.abs(m.touchesCurrent.x - v.prevPositionX) < 2 && (v.x = 0), Math.abs(m.touchesCurrent.y - v.prevPositionY) < 2 && (v.y = 0), v.prevPositionX = m.touchesCurrent.x, v.prevPositionY = m.touchesCurrent.y, v.prevTime = Date.now(), h.imageWrapEl.style.transform = `translate3d(${m.currentX}px, ${m.currentY}px,0)`
        }
        ...
        function M(e) {
            ...
            let s, r, a, l, d, u, p, v, y, w, _, E, x, S, T, C, M, L;
            t.params.cssMode && (t.wrapperEl.style.overflow = "hidden", t.wrapperEl.style.touchAction = "none"), h.slideEl.classList.add("" + n.zoomedSlideClass), void 0 === m.touchesStart.x && e ? (s = e.pageX, r = e.pageY) : (s = m.touchesStart.x, r = m.touchesStart.y);
            const I = "number" == typeof e ? e : null;
            1 === c && I && (s = void 0, r = void 0), i.scale = I || h.imageWrapEl.getAttribute("data-swiper-zoom") || n.maxRatio, c = I || h.imageWrapEl.getAttribute("data-swiper-zoom") || n.maxRatio, !e || 1 === c && I ? (p = 0, v = 0) : (M = h.slideEl.offsetWidth, L = h.slideEl.offsetHeight, a = g(h.slideEl).left + o.scrollX, l = g(h.slideEl).top + o.scrollY, d = a + M / 2 - s, u = l + L / 2 - r, y = h.imageEl.offsetWidth, w = h.imageEl.offsetHeight, _ = y * i.scale, E = w * i.scale, x = Math.min(M / 2 - _ / 2, 0), S = Math.min(L / 2 - E / 2, 0), T = -x, C = -S, p = d * i.scale, v = u * i.scale, p < x && (p = x), p > T && (p = T), v < S && (v = S), v > C && (v = C)), I && 1 === i.scale && (h.originX = 0, h.originY = 0), h.imageWrapEl.style.transitionDuration = "300ms", h.imageWrapEl.style.transform = `translate3d(${p}px, ${v}px,0)`, h.imageEl.style.transitionDuration = "300ms", h.imageEl.style.transform = `translate3d(0,0,0) scale(${i.scale})`
        }
        ...
        function O() {
            ...
            t.wrapperEl.addEventListener("pointerdown", E, i), t.wrapperEl.addEventListener("pointermove", x, n), ["pointerup", "pointercancel", "pointerout"].forEach(e => {
        ...
        function A() {
            ...
            t.wrapperEl.removeEventListener("pointerdown", E, i), t.wrapperEl.removeEventListener("pointermove", x, n), ["pointerup", "pointercancel", "pointerout"].forEach(e => {
        ...
        Object.defineProperty(t.zoom, "scale", {
            ...
            t.zoom.enabled && function () {
                ...
                const s = v.x * i,
                    ...
                    o = v.y * n,
                    a = m.currentY + o;
                0 !== v.x && (i = Math.abs((r - m.currentX) / v.x)), 0 !== v.y && (n = Math.abs((a - m.currentY) / v.y));
        ...
        const b = (e, t, i) => {
            a(e), "BUTTON" !== e.tagName && (d(e, "button"), e.addEventListener("keydown", f)), u(e, i),
                function (e, t) {
                    (e = o(e)).forEach(e => {
        ...
        n("beforeInit", () => {
            s = m("span", t.params.a11y.notificationClass), s.setAttribute("aria-live", "assertive"), s.setAttribute("aria-atomic", "true")
        }), n("afterInit", () => {
            t.params.a11y.enabled && (() => {
                ...
                const n = t.wrapperEl,
                    r = e.id || n.getAttribute("id") || "swiper-wrapper-" + (void 0 === (a = 16) && (a = 16), "x".repeat(a).replace(/x/g, () => Math.round(16 * Math.random()).toString(16)));
                var a;
                ...
                p = o(p), h = o(h), p && p.forEach(t => b(t, r, e.nextSlideMessage)), h && h.forEach(t => b(t, r, e.prevSlideMessage)), v() && (Array.isArray(t.pagination.el) ? t.pagination.el : [t.pagination.el]).forEach(e => {
                    e.addEventListener("keydown", f)
                }), t.el.addEventListener("focus", E, !0), t.el.addEventListener("pointerdown", w, !0), t.el.addEventListener("pointerup", _, !0)
            })()
            ...
            t.params.a11y.enabled && function () {
                ...
                g() && t.pagination.bullets.forEach(i => {
                    t.params.pagination.clickable && (a(i), t.params.pagination.renderBullet || (d(i, "button"), u(i, e.paginationBulletMessage.replace(/\{\{index\}\}/, y(i) + 1)))), i.matches(U(t.params.pagination.bulletActiveClass)) ? i.setAttribute("aria-current", "true") : i.removeAttribute("aria-current")
                })
            }()
        }), n("destroy", () => {
            t.params.a11y.enabled && function () {
                ...
                e = o(e), i = o(i), e && e.forEach(e => e.removeEventListener("keydown", f)), i && i.forEach(e => e.removeEventListener("keydown", f)), v() && (Array.isArray(t.pagination.el) ? t.pagination.el : [t.pagination.el]).forEach(e => {
                    e.removeEventListener("keydown", f)
                }), t.el.removeEventListener("focus", E, !0), t.el.removeEventListener("pointerdown", w, !0), t.el.removeEventListener("pointerup", _, !0)
            }()
        })
    }, function (e) {
        let {
        ...
        const a = e => e.toString().replace(/\s+/g, "-").replace(/[^\w-]+/g, "").replace(/--+/g, "-").replace(/^-+/, "").replace(/-+$/, ""),
            ...
            d = (e, i) => {
                ...
                c && c.value === d || (t.params.history.replaceState ? n.history.replaceState({
                    value: d
        ...
        n("init", () => {
            t.params.history.enabled && (() => {
                ...
                if (t.params.history) {
                    ...
                    s = !0, o = l(t.params.url), o.key || o.value ? (c(0, o.value, t.params.runCallbacksOnInit), t.params.history.replaceState || e.addEventListener("popstate", u)) : t.params.history.replaceState || e.addEventListener("popstate", u)
                }
            })()
        }), n("destroy", () => {
            t.params.history.enabled && (() => {
        ...
        let d, c, u, p, h, f, m, g = l && l.autoplay ? l.autoplay.delay : 3e3,
            v = l && l.autoplay ? l.autoplay.delay : 3e3,
            y = (new Date).getTime;

        function b(e) {
            s && !s.destroyed && s.wrapperEl && e.target === s.wrapperEl && (s.wrapperEl.removeEventListener("transitionend", b), T())
        }
        const w = () => {
            if (s.destroyed || !s.autoplay.running) return;
            s.autoplay.paused ? c = !0 : c && (v = d, c = !1);
            const e = s.autoplay.paused ? d : y + v - (new Date).getTime();
            s.autoplay.timeLeft = e, a("autoplayTimeLeft", e, e / g), i = requestAnimationFrame(() => {
                w()
            })
        },
            _ = e => {
                ...
                !Number.isNaN(r) && r > 0 && void 0 === e && (n = r, g = r, v = r), d = n;
                const o = s.params.speed,
                    l = () => {
                        s && !s.destroyed && (s.params.autoplay.reverseDirection ? !s.isBeginning || s.params.loop || s.params.rewind ? (s.slidePrev(o, !0, !0), a("autoplay")) : s.params.autoplay.stopOnLastSlide || (s.slideTo(s.slides.length - 1, o, !0, !0), a("autoplay")) : !s.isEnd || s.params.loop || s.params.rewind ? (s.slideNext(o, !0, !0), a("autoplay")) : s.params.autoplay.stopOnLastSlide || (s.slideTo(0, o, !0, !0), a("autoplay")), s.params.cssMode && (y = (new Date).getTime(), requestAnimationFrame(() => {
                            _()
                        })))
                    };
            ...
            S = (e, i) => {
                ...
                const n = () => {
                    a("autoplayPause"), s.params.autoplay.waitForTransition ? s.wrapperEl.addEventListener("transitionend", b) : T()
                };
                if (s.autoplay.paused = !0, i) return f && (d = s.params.autoplay.delay), f = !1, void n();
                const r = d || s.params.autoplay.delay;
                d = r - ((new Date).getTime() - y), s.isEnd && d < 0 && !s.params.loop || (d < 0 && (d = 0), n())
            },
            T = () => {
                s.isEnd && d < 0 && !s.params.loop || s.destroyed || !s.autoplay.running || (y = (new Date).getTime(), m ? (m = !1, _(d)) : _(), s.autoplay.paused = !1, a("autoplayResume"))
            },
            C = () => {
                if (s.destroyed || !s.autoplay.running) return;
                const e = n();
            ...
            M = e => {
                "mouse" === e.pointerType && (m = !0, s.animating || s.autoplay.paused || S(!0))
            },
            L = e => {
                "mouse" === e.pointerType && s.autoplay.paused && T()
            };
        o("init", () => {
            s.params.autoplay.enabled && (s.params.autoplay.pauseOnMouseEnter && (s.el.addEventListener("pointerenter", M), s.el.addEventListener("pointerleave", L)), n().addEventListener("visibilitychange", C), y = (new Date).getTime(), E())
        }), o("destroy", () => {
            s.el.removeEventListener("pointerenter", M), s.el.removeEventListener("pointerleave", L), n().removeEventListener("visibilitychange", C), s.autoplay.running && x()
        }), o("beforeTransitionStart", (e, t, i) => {
            !s.destroyed && s.autoplay.running && (i || !s.params.autoplay.disableOnInteraction ? S(!0, !0) : x())
        }), o("sliderFirstMove", () => {
            !s.destroyed && s.autoplay.running && (s.params.autoplay.disableOnInteraction ? x() : (u = !0, p = !1, m = !1, h = setTimeout(() => {
                m = !0, p = !0, S(!0)
            }, 200)))
        }), o("touchEnd", () => {
            if (!s.destroyed && s.autoplay.running && u) {
                if (clearTimeout(h), clearTimeout(t), s.params.autoplay.disableOnInteraction) return p = !1, void (u = !1);
        ...
        function c(e) {
            ...
            if (t.params.slidesPerView > 1 && !t.params.centeredSlides && (s = t.params.slidesPerView), t.params.thumbs.multipleActiveThumbs || (s = 1), s = Math.floor(s), i.slides.forEach(e => e.classList.remove(r)), i.params.loop || i.params.virtual && i.params.virtual.enabled)
                for (let e = 0; e < s; e += 1) f(i.slidesEl, `[data-swiper-slide-index="${t.realIndex + e}"]`).forEach(e => {
                    e.classList.add(r)
                });
            else
                    ...
                    const i = n(),
                        s = () => {
                            ...
                            if (n && n.swiper) e.swiper = n.swiper, l(), c(!0);
                                ...
                                const i = s => {
                                    e.swiper = s.detail[0], n.removeEventListener("init", i), l(), c(!0), e.swiper.update(), t.update()
                                };
                        ...
                        if (r.freeMode.momentum) {
                            if (c.velocities.length > 1) {
                                const e = c.velocities.pop(),
                                    ...
                                    s = e.time - i.time;
                                t.velocity = n / s, t.velocity /= 2, Math.abs(t.velocity) < r.freeMode.minimumVelocity && (t.velocity = 0), (s > 150 || a() - e.time > 300) && (t.velocity = 0)
                            } else t.velocity = 0;
                            ...
                            let m;
                            if (u < t.maxTranslate()) r.freeMode.momentumBounce ? (u + t.maxTranslate() < -f && (u = t.maxTranslate() - f), p = t.maxTranslate(), h = !0, c.allowMomentumBounce = !0) : u = t.maxTranslate(), r.loop && r.centeredSlides && (m = !0);
                            else if (u > t.minTranslate()) r.freeMode.momentumBounce ? (u - t.minTranslate() > f && (u = t.minTranslate() + f), p = t.minTranslate(), h = !0, c.allowMomentumBounce = !0) : u = t.minTranslate(), r.loop && r.centeredSlides && (m = !0);
                            ...
                            r.freeMode.momentumBounce && h ? (t.updateProgress(p), t.setTransition(e), t.setTranslate(u), t.transitionStart(!0, t.swipeDirection), t.animating = !0, w(o, () => {
                                t && !t.destroyed && c.allowMomentumBounce && (n("momentumBounce"), t.setTransition(r.speed), setTimeout(() => {
                                    t.setTranslate(p), w(o, () => {
                                        t && !t.destroyed && t.transitionEnd()
                                    })
                                }, 0))
                            })) : t.velocity ? (n("_freeModeNoMomentumRelease"), t.updateProgress(u), t.setTransition(e), t.setTranslate(u), t.transitionStart(!0, t.swipeDirection), t.animating || (t.animating = !0, w(o, () => {
                                t && !t.destroyed && t.transitionEnd()
        ...
        a("init", () => {
            ...
            initSlides: e => {
                ...
                n = Math.floor(e / o), t = Math.floor(e / o) === e / o ? e : Math.ceil(e / o) * o, "auto" !== s && "row" === a && (t = Math.max(t, s * o)), i = t / o
            },
            updateSlide: (e, s, o, a) => {
                const {
                    slidesPerGroup: d
                ...
                if ("row" === p && d > 1) {
                    ...
                    m = Math.floor(n / r), f = n - m * r + i * d, h = f + m * t / u, s.style.order = h
                } else "column" === p ? (f = Math.floor(e / u), m = e - f * u, (f > n || f === n && m === u - 1) && (m += 1, m >= u && (m = 0, f += 1))) : (m = Math.floor(e / i), f = e - m * i);
                s.row = m, s.column = f, s.style[a("margin-top")] = 0 !== m ? c && c + "px" : ""
            },
            updateWrapperSize: (e, i, n) => {
                ...
                if (r.virtualSize = (e + a) * t, r.virtualSize = Math.ceil(r.virtualSize / d) - a, r.wrapperEl.style[n("width")] = r.virtualSize + a + "px", s) {
                    const e = [];
                    for (let t = 0; t < i.length; t += 1) {
                        let n = i[t];
                        o && (n = Math.floor(n)), i[t] < r.virtualSize + i[0] && e.push(n)
                    }
        ...
        const s = (e, t, i) => {
            ...
            n || (n = m("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (i ? "left" : "top")).split(" ")), e.append(n)), s || (s = m("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (i ? "right" : "bottom")).split(" ")), e.append(s)), n && (n.style.opacity = Math.max(-t, 0)), s && (s.style.opacity = Math.max(t, 0))
        };
        te({
            effect: "cube",
            swiper: t,
            ...
            setTranslate: () => {
                ...
                let h, f = 0;
                c.shadow && (u ? (h = t.wrapperEl.querySelector(".swiper-cube-shadow"), h || (h = m("div", "swiper-cube-shadow"), t.wrapperEl.append(h)), h.style.height = r + "px") : (h = e.querySelector(".swiper-cube-shadow"), h || (h = m("div", "swiper-cube-shadow"), e.append(h))));
                for (let e = 0; e < n.length; e += 1) {
                    const t = n[e];
                    let i = e;
                    ...
                    let h = 0,
                        m = 0,
                        g = 0;
                    i % 4 == 0 ? (h = 4 * -o * l, g = 0) : (i - 1) % 4 == 0 ? (h = 0, g = 4 * -o * l) : (i - 2) % 4 == 0 ? (h = l + 4 * o * l, g = l) : (i - 3) % 4 == 0 && (h = -l, g = 3 * l + 4 * l * o), a && (h = -h), u || (m = h, h = 0);
                    const v = `rotateX(${u ? 0 : -r}deg) rotateY(${u ? r : 0}deg) translate3d(${h}px, ${m}px, ${g}px)`;
                    d <= 1 && d > -1 && (f = 90 * i + 90 * d, a && (f = 90 * -i - 90 * d)), t.style.transform = v, c.slideShadows && s(t, d, u)
                }
                if (i.style.transformOrigin = `50% 50% -${l / 2}px`, i.style["-webkit-transform-origin"] = `50% 50% -${l / 2}px`, c.shadow)
                    if (u) h.style.transform = `translate3d(0px, ${r / 2 + c.shadowOffset}px, ${-r / 2}px) rotateX(90deg) rotateZ(0deg) scale(${c.shadowScale})`;
                    else {
                    ...
                    } const g = (d.isSafari || d.isWebView) && d.needPerspectiveFix ? -l / 2 : 0;
        ...
        const s = (e, i) => {
            ...
            n || (n = se("flip", e, t.isHorizontal() ? "left" : "top")), s || (s = se("flip", e, t.isHorizontal() ? "right" : "bottom")), n && (n.style.opacity = Math.max(-i, 0)), s && (s.style.opacity = Math.max(i, 0))
        };
        te({
            effect: "flip",
            swiper: t,
            ...
            setTranslate: () => {
                ...
                for (let r = 0; r < e.length; r += 1) {
                    ...
                    let d = -180 * a,
                        ...
                        p = 0;
                    t.isHorizontal() ? i && (d = -d) : (p = u, u = 0, c = -d, d = 0), o.style.zIndex = -Math.abs(Math.round(a)) + e.length, n.slideShadows && s(o, a);
        ...
        i({
            ...
            setTranslate: () => {
                const {
                    ...
                    slides: n,
                    slidesSizesGrid: s
                } = t, r = t.params.coverflowEffect, o = t.isHorizontal(), a = t.translate, l = o ? e / 2 - a : i / 2 - a, d = o ? r.rotate : -r.rotate, c = r.depth;
                for (let e = 0, t = n.length; e < t; e += 1) {
                    ...
                    if (ie(0, t).style.transform = b, t.style.zIndex = 1 - Math.abs(Math.round(u)), r.slideShadows) {
                        ...
                        e || (e = se("coverflow", t, o ? "left" : "top")), i || (i = se("coverflow", t, o ? "right" : "bottom")), e && (e.style.opacity = u > 0 ? u : 0), i && (i.style.opacity = -u > 0 ? -u : 0)
                    }
                }
            },
            setTransition: e => {
        ...
        te({
            ...
            setTranslate: () => {
                ...
                for (let i = 0; i < e.length; i += 1) {
                    ...
                    let c = d;
                    a || (c = Math.min(Math.max(n.originalProgress, -r.limitProgress), r.limitProgress));
                    ...
                    d < 0 ? (m = r.next, f = !0) : d > 0 && (m = r.prev, f = !0), p.forEach((e, t) => {
                        p[t] = `calc(${e}px + (${s(m.translate[t])} * ${Math.abs(d * o)}))`
                    }), h.forEach((e, t) => {
                        h[t] = m.rotate[t] * Math.abs(d * o)
                    }), n.style.zIndex = -Math.abs(Math.round(l)) + e.length;
                    const g = p.join(", "),
                        v = `rotateX(${h[0]}deg) rotateY(${h[1]}deg) rotateZ(${h[2]}deg)`,
                        y = c < 0 ? `scale(${1 + (1 - m.scale) * c * o})` : `scale(${1 - (1 - m.scale) * c * o})`,
                        b = c < 0 ? 1 + (1 - m.opacity) * c * o : 1 - (1 - m.opacity) * c * o,
                        w = `translate3d(${g}) ${v} ${y}`;
                    if (f && m.shadow || !f) {
                    ...
                    const _ = ie(0, n);
                    _.style.transform = w, _.style.opacity = b, m.origin && (_.style.transformOrigin = m.origin)
                }
            },
            setTransition: e => {
                const i = t.slides.map(e => h(e));
            ...
            setTranslate: () => {
                ...
                for (let l = 0; l < e.length; l += 1) {
                    ...
                    const b = t.virtual && t.params.virtual.enabled ? t.virtual.from + l : l,
                        ...
                        _ = (b === i || b === i + 1) && u < 0 && u > -1 && (o || t.params.cssMode) && a > r;
                    if (w || _) {
                        const e = (1 - Math.abs((Math.abs(u) - .5) / .5)) ** .5;
                        v += -28 * u * e, g += -.5 * e, y += 96 * e, f = -25 * e * Math.abs(u) + "%"
                    }
                    if (h = u < 0 ? `calc(${h}px ${n ? "-" : "+"} (${y * Math.abs(u)}%))` : u > 0 ? `calc(${h}px ${n ? "-" : "+"} (-${y * Math.abs(u)}%))` : h + "px", !t.isHorizontal()) {
                        const e = f;
                        f = h, h = e
                    }
                    ...
                    if (s.slideShadows) {
                        ...
                        e || (e = se("cards", d)), e && (e.style.opacity = Math.min(Math.max((Math.abs(u) - .5) / .5, 0), 1))
                    }
                    d.style.zIndex = -Math.abs(Math.round(c)) + e.length, ie(0, d).style.transform = x
                }
            },
            setTransition: e => {
                const i = t.slides.map(e => h(e));

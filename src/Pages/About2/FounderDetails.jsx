        ...
        <div className="row align-items-center">
          <div className="col-lg-6">
            <div className="founder-img">
              <img src="/images/Founder3.jpg" alt="Founder" />
          ...
          <div className="col-lg-6" style={{marginTop: "30px"}}>
            <div className="founder-content">
              ...
              <p className="sec-text" data-aos="fade-up">The foundation of Samrat Masale was established in 1965 by Shri Shyamsundar Ji Vijayvargiya. At that time,
              ...
              <div className="founder-info" data-aos="fade-up">
                <h4 className="founder-name">Shri Shyamsundar Ji Vijayvargiya</h4>
